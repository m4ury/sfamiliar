...
class EstadisticaController extends Controller
{
    ...
    public function seccionB()
    {
        ...
        $pa140_80M = $pacientes->pa140()->get()->where('grupo', '>', 79)->where('pacientes.sexo', 'Masculino')->count();
