                    ...
                    <div class="list-group-item list-group-item my-3 text-bold ">
                        ...
                        @if($patologia->nombre_patologia == 'DM2')
                            <div class="form-group row">
                                ...
                                <= 365 && $paciente->controlPodologico_alDia != null && $paciente->controlPodologico_alDia!= '0000/00/00')
                                    <div class="col-sm-4">
                                ...
                                <= 365 && $paciente->aputacionPieDM2 != null && $paciente->aputacionPieDM2!= '0000/00/00')
                                    <div class="col-sm-5">
