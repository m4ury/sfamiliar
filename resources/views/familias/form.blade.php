...
<div class="form-group row">
    ...
    <div class="col-sm-5">
        {!! Form::text('domicilio',old('domicilio', $familia->domicilio ?? ''), ['class' => 'form-control form-control-sm'.($errors->has('domicilio') ? ' is-invalid' : '')]) !!}
...
<div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-5">
            {!! Form::select('sector', ['SB' => 'Naranjo (SB)', 'SA' => 'Celeste (SA)'], old('sector', $familia->sector ?? ''), ['class' => 'form-control form-control-sm', 'placeholder' => 'Seleccione Sector', 'id' => 'sector']) !!}
        ...
        <div class="col-sm-5">
            {!! Form::number('ficha_familiar',old('ficha_familiar', $familia->ficha_familiar ?? ''), ['class' => 'form-control form-control-sm'.($errors->has('ficha_familiar') ? '
