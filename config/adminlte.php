        ...
        'Datatables' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/buttons/1.5.6/js/buttons.flash.min.js'
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                ...
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/buttons/1.5.6/css/buttons.dataTables.min.css',
                ],
            ],
        ],
        'Select2' => [
        ...
        'Pace' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/pace/1.0.2/themes/blue/pace-theme-center-circle.css',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
